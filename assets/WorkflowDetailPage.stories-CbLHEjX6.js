import{d as M,U as L,a2 as j,v as R,j as V,m as e,r as s}from"./iframe-D7BbHDbG.js";import{s as q}from"./index-BKr2PyJj.js";import{s as G}from"./index-DCVTeUli.js";import{s as O}from"./index-XbhyUeFS.js";import{s as U}from"./index-DBWVCl5L.js";import{s as W,a as H}from"./index-CiXhdmRB.js";import{s as X}from"./index-CUoDpPp7.js";import"./RichText.vue-1XZLRn0K.js";import{_ as Q}from"./ToggleSwitch.vue-D6arVeMJ.js";import{_ as J}from"./FormField.vue-BiV6ZEgt.js";import{_ as K}from"./AppNavigation.vue-BO4jtGC6.js";import{_ as Y}from"./PageHeader.vue-0YQpSj3p.js";import{_ as Z}from"./AdminTopBar-Chx_4VGs.js";import{w as y,d as ee,a as te,b as se,s as ae,c as le,p as ie,e as oe}from"./index-CKmPII1G.js";import{r as ne}from"./PencilIcon-5Jfjkumk.js";import{r as I}from"./ClipboardDocumentListIcon-DLWg2TFY.js";import{r as re}from"./ChevronRightIcon-BrFzWSch.js";import{r as de}from"./TrashIcon-zSr6WN2U.js";import{r as ce}from"./ComputerDesktopIcon-BY-6jc1E.js";import{r as pe}from"./ArrowsRightLeftIcon-Pd4aurkf.js";import{r as me}from"./FunnelIcon-BW6Ml2Am.js";import{r as ue}from"./CheckIcon-DNEDYMqg.js";import{r as ve}from"./ArrowPathIcon-CfGxZalC.js";import{r as be}from"./EnvelopeIcon-CZ7sSg4P.js";import{r as fe}from"./PlusIcon-B94kIdrt.js";import{r as xe}from"./InformationCircleIcon-Cfsekz4Z.js";import{r as ge}from"./PlayIcon-vhEdDeH7.js";import{r as he}from"./BoltIcon-C5wCsidw.js";import{r as ye}from"./ArrowRightStartOnRectangleIcon-B91pfFJz.js";import{r as Ie}from"./ArrowTopRightOnSquareIcon-_aQH2B8X.js";import{r as we,a as ke}from"./RocketLaunchIcon-BIuD1oEk.js";import{r as Pe,a as ze}from"./HomeIcon-XZc1Dfyu.js";import{r as Be}from"./UserIcon-DRjp4_6R.js";import{r as Se}from"./UsersIcon-BbZ6Qpdm.js";import{r as Ae}from"./UserGroupIcon-Ctmauh4_.js";import{r as Ee}from"./CommandLineIcon-CWVZZFIo.js";import{r as Te}from"./ShieldCheckIcon-BY_KE66K.js";import{r as Ce}from"./Cog6ToothIcon-DbA3VXm8.js";import"./preload-helper-Dp1pzeXC.js";import"./index-5dj8dpAI.js";import"./index-BKtZXsJ2.js";import"./index-oNdbppoo.js";import"./index-BCWryaxY.js";import"./index-ZhWAdK_X.js";import"./index-1reqc7Wl.js";import"./index-2h6QqnDj.js";import"./index-DrYGcJBA.js";import"./index-BaidBBYU.js";import"./index-D1TpkbyC.js";import"./index-BHG3Q-Ws.js";import"./index-0gxlrFf7.js";import"./index-DSpYqzCj.js";import"./index-BDr-K8Vc.js";import"./index-DHnCHi6v.js";import"./index-CCeEX0h1.js";import"./ExclamationCircleIcon-CLIjVPIb.js";import"./ExclamationTriangleIcon-uPO_hbeV.js";import"./CheckCircleIcon-Ctb-iWK2.js";import"./index-DdqW2O0M.js";import"./index-pQFxUuf4.js";import"./index-DopepIUV.js";import"./index-BVixZLR4.js";import"./index-CLbTpqPL.js";import"./index-CA7vwr87.js";import"./index-DP0gcRj_.js";import"./Dropdown.vue-D2xWW_V3.js";import"./EllipsisHorizontalIcon-Dlw4O3VD.js";import"./index-D-Q9u-0k.js";import"./AiAgentButton.vue-DoZHtGB6.js";import"./ArrowLeftIcon-BcjWK0Vo.js";import"./FlagIcon-BljeC-Dg.js";const Fe=[{label:"Get Started",leftIcon:e(we)},{label:"Home",leftIcon:e(Pe)},{label:"Alert",leftIcon:e(ze),count:23,isNew:!0},{label:"User Management",leftIcon:e(Ae),items:[{label:"Users",leftIcon:e(Be)},{label:"User Groups",leftIcon:e(Se)},{separator:!0},{label:"Active Directory"},{label:"Cloud Directories"},{label:"HR Directories"},{label:"Identity Provider"}]},{label:"Device Management",leftIcon:e(se),items:[{label:"Devices",leftIcon:e(ee)},{label:"Device Groups",leftIcon:e(te)},{label:"Commands",leftIcon:e(Ee)},{label:"Asset Management",leftIcon:e(I),isNew:!0},{separator:!0},{label:"Policy Management"},{label:"Policy Groups"},{label:"Software Deployment"},{label:"MDM"}]},{label:"Access",leftIcon:e(oe),items:[{label:"SSO Applications",leftIcon:e(ae)},{label:"Access Reports",isNew:!0},{label:"SaaS Management",leftIcon:e(le)},{label:"Password Management",leftIcon:e(ie)},{label:"LDAP"},{label:"RADIUS"}]},{label:"Workflows",leftIcon:e(y),items:[{label:"All Workflows"},{label:"Triggers"}]},{label:"Security",leftIcon:e(Te),items:[{label:"Conditional Access Policies"},{label:"Conditional List"},{label:"MFA Configurations"},{label:"Device Trust"}]},{label:"Insights",leftIcon:e(ke),items:[{label:"Reports"},{label:"Directory Insights"}]},{label:"Settings",leftIcon:e(Ce)}],_e=[{label:"Burak Başcı",itemType:"profile_compact",initials:"BB",name:"Burak Başcı",items:[{label:"Admin IT",itemType:"profile_large",name:"Admin IT",email:"admin_it@company.com",initials:"AT"},{separator:!0},{label:"Logout",rightIcon:e(ye)},{separator:!0},{label:"Change Password"},{label:"Launch User Portal",rightIcon:e(Ie)},{separator:!0},{label:"Billing"},{label:"My API Key"},{separator:!0},{label:"Use Old Navigation",itemType:"button"}]}],Ne=[{label:"Overview",value:"overview"},{label:"Execution history",value:"execution-history"}],$e=M({name:"WorkflowDetailPage",components:{AppNavigation:K,PageHeader:Y,ToggleSwitch:Q,FormField:J,PvButton:q,PvTag:X,PvInputText:G,PvSelect:O,PvDialog:U,PvIconField:H,PvInputIcon:W,AdminTopBar:Z,BoltIcon:he,PlayIcon:ge,XMarkIcon:V,InformationCircleIcon:xe,PlusIcon:fe,EnvelopeIcon:be,ArrowPathIcon:ve,CheckIcon:ue,MagnifyingGlassIcon:R,FunnelIcon:me,ArrowsRightLeftIcon:pe,ComputerDesktopIcon:ce,ClockIcon:j,TrashIcon:de,ChevronDownIcon:L,ChevronRightIcon:re,ClipboardDocumentListIcon:I,PencilIcon:ne},setup(){const w=s("overview"),k=s(!0),m=s(null),d=s({trigger:"User suspended",loop:"Loop","remove-device":"Remove device","send-email":"Send email","if-else":"If Else"}),l=s(null),n=s("");function P(t){l.value=t,n.value=d.value[t]??""}function z(){if(l.value){const t=n.value.trim();t&&(d.value[l.value]=t)}l.value=null,n.value=""}const B=s("List user systems"),S=s("Device removed"),u=s(["Email channel 1","Email channel 2","Email channel 3"]),c=s(!1),A=s(""),E=[{category:"Flow",closable:!0,items:[{id:"if-else",label:"If else",description:"An if-else allows your workflow to make decisions based on conditions. If a specific condition is true, it executes a certain block of code; otherwise, it runs an alternative block.",icon:"ArrowsRightLeftIcon",iconBg:"bg-chart-violet-dark"},{id:"loops",label:"Loops",description:"A for loop automates repetitive tasks by iterating over a set of items, allowing you to execute a block of code multiple times efficiently.",icon:"ArrowPathIcon",iconBg:"bg-chart-violet-dark"}]},{category:"Jumpcloud Actions",items:[{id:"remove-devices",label:"Remove devices",description:"Removing devices will allow you to disconnect or uninstall hardware from your system, ensuring that it no longer interfere with your operations.",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"},{id:"get-systems",label:"Get Systems",description:"To retrieve devices, ensuring that it collects the latest information on their status and availability.",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"},{id:"send-email-channel",label:"Send notification via email channel",description:"Execute tailored or standard scripts seamlessly across macOS, Windows, and Linux platforms.",icon:"EnvelopeIcon",iconBg:"bg-chart-branding-base"},{id:"send-webhook",label:"Send notification via webhook",description:"Execute tailored or standard scripts seamlessly across macOS, Windows, and Linux platforms.",icon:"ClockIcon",iconBg:"bg-chart-branding-base"}]}],T=[{label:"User suspended event",items:[{label:"user.id",value:"user.id"},{label:"device id",value:"device id"},{label:"initiatedby.email",value:"initiatedby.email"},{label:"Variable name",value:"Variable name"}]},{label:"Get Systems",items:[{label:"List user systems",value:"List user systems",description:"This retrieves a list of systems linked to a user ID."}]}],C=t=>{u.value.splice(t,1)},v=s(!1),i=s(null);let F=2,_=1;const a=s([{id:1,type:"if",variable:"",operator:"equals",value:"",expanded:!0,actions:[]}]),p=s([]),N=[{label:"Equals",value:"equals"},{label:"Not equals",value:"not_equals"},{label:"Contains",value:"contains"},{label:"Does not contain",value:"not_contains"},{label:"Greater than",value:"greater_than"},{label:"Less than",value:"less_than"},{label:"Is empty",value:"is_empty"},{label:"Is not empty",value:"is_not_empty"}],$=[{label:"user.id",value:"user.id"},{label:"device.id",value:"device.id"},{label:"initiatedby.email",value:"initiatedby.email"},{label:"input.resource.id",value:"input.resource.id"}],D={"remove-devices":{label:"Remove devices",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"},"get-systems":{label:"Get Systems",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"},"send-email-channel":{label:"Send notification via email channel",icon:"EnvelopeIcon",iconBg:"bg-chart-branding-base"},"send-webhook":{label:"Send notification via webhook",icon:"ClockIcon",iconBg:"bg-chart-branding-base"},loops:{label:"Loops",icon:"ArrowPathIcon",iconBg:"bg-chart-violet-dark"}};return{menuItems:Fe,profileMenuItems:_e,tabs:Ne,activeTab:w,isEnabled:k,selectedStep:m,loopInputValue:B,emailSubject:S,emailChannels:u,variableOptions:T,removeChannel:C,showActionTypeModal:c,actionSearchQuery:A,actionTypes:E,showIfElseNode:v,ifElseConditions:a,elseActions:p,operatorOptions:N,conditionVariables:$,handleActionTypeSelect:t=>{if(c.value=!1,i.value!==null){const o=i.value,b=D[t];if(b){const f={id:_++,actionId:t,...b};o===-1?p.value.push(f):a.value[o].actions.push(f)}i.value=null;return}t==="if-else"&&(v.value=!0,m.value="if-else")},addCondition:()=>{a.value.push({id:F++,type:"else-if",variable:"",operator:"equals",value:"",expanded:!0,actions:[]})},removeCondition:t=>{a.value.splice(t,1)},openBranchActionModal:t=>{i.value=t,c.value=!0},removeActionFromBranch:(t,o)=>{t===-1?p.value.splice(o,1):a.value[t].actions.splice(o,1)},toggleBranch:t=>{a.value[t].expanded=!a.value[t].expanded},addingActionToBranchIndex:i,WorkflowIcon:e(y),nodeNames:d,editingNodeId:l,editingValue:n,startEditing:P,finishEditing:z}},template:`
  ...
  `}),is={title:"Projects/Bala Playground/Pages/Workflow Detail",component:$e,parameters:{layout:"fullscreen"}},r={};var x,g,h;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:"{}",...(h=(g=r.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};const os=["Default"];export{r as Default,os as __namedExportsOrder,is as default};
