...
const HomePageStory = defineComponent({
  name: 'HomePageStory',
  components: {
    AppNavigation,
    PageHeader,
  ...
  template: `
    <div class="flex h-screen overflow-hidden">
      ...
      <div class="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden">
        ...
        <PageHeader
          title="Home"
          subtitleText="Dashboard overview and activity"
        >
          <template #icon>
...
const meta: Meta<typeof HomePageStory> = {
  title: "Projects/Mike's Playground/Page Explorations/Homepage",
...
type Story = StoryObj<typeof HomePageStory>;
