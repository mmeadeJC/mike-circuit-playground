...
const props = withDefaults(defineProps<ConfigPageLayoutProps>(), {
  maxWidth: '1280',
});
...
<template>
  <div class="w-screen h-screen flex">
    <div class="layout-container @container flex-[1_1_0] min-w-0 min-h-0" data-layout="config">
