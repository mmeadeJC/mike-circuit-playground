import{s as r}from"./index-DdDMkWFP.js";import"./iframe-DSI7I_YQ.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DASh1IA2.js";import"./index-Cg08wAe5.js";import"./index-Ck3k_J8K.js";import"./index-CwTDpyKH.js";import"./index-ZhWAdK_X.js";import"./index-Cm1NVGCj.js";const Le={title:"Circuit DS/Components/Button",component:r,tags:["autodocs"],argTypes:{severity:{control:"select",options:["primary","secondary","danger"]},variant:{control:"select",options:[void 0,"outlined","text"]},label:{control:"text"},disabled:{control:"boolean"},size:{control:"select",options:[void 0,"small","large"]},icon:{control:"text"},iconPos:{control:"select",options:["left","right"]},loading:{control:"boolean"}}},a={args:{label:"Primary",severity:"primary"}},t={args:{label:"Secondary",severity:"secondary"}},n={args:{label:"Danger",severity:"danger"}},s={name:"Outlined / Primary",args:{label:"Outlined Primary",severity:"primary",variant:"outlined"}},o={name:"Outlined / Secondary",args:{label:"Outlined Secondary",severity:"secondary",variant:"outlined"}},l={name:"Outlined / Danger",args:{label:"Outlined Danger",severity:"danger",variant:"outlined"}},i={name:"Text / Primary",args:{label:"Text Primary",severity:"primary",variant:"text"}},c={name:"Text / Secondary",args:{label:"Text Secondary",severity:"secondary",variant:"text"}},m={name:"Text / Danger",args:{label:"Text Danger",severity:"danger",variant:"text"}},d={name:"Icon Only",render:e=>({components:{Button:r},setup(){return{args:e}},template:`
      <Button v-bind="args">
        <template #icon>
