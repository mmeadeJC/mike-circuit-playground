...
const SimplePageStory = defineComponent({
  name: 'SimplePageStory',
  components: {
    AppNavigation,
    PageHeader,
    AdminTopBar,
  ...
  template: `
    <div class="flex h-screen overflow-hidden">
      ...
      <div class="flex-1 flex flex-col min-w-0 overflow-auto">
        <AdminTopBar />
        <PageHeader
          title="Farhana's Playground"
          subtitleText="A simple page with a header and a button"
        >
          <template #icon>
            <HomeIcon class="size-7 text-neutral-base" />
          </template>
        </PageHeader>
        <SimplePage />
      </div>
...
const meta: Meta<typeof SimplePageStory> = {
  title: "Projects/Farhana's Playground/Pages/Simple Page",
  component: SimplePageStory,
  parameters: {
    layout: 'fullscreen',
  },
};
...
type Story = StoryObj<typeof SimplePageStory>;
