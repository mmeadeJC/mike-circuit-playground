...
import AdminSettingsPageAlt from './AdminSettingsPageAlt.vue';
...
const AdminSettingsPageAltStory = defineComponent({
  name: 'AdminSettingsPageAltStory',
  components: {
    AppNavigation,
    PageHeader,
    AdminTopBar,
    AdminSettingsPageAlt,
    Cog6ToothIcon,
  },
  setup() {
  ...
  template: `
    <div class="flex h-screen overflow-hidden">
      ...
      <div class="flex-1 flex flex-col min-w-0 overflow-auto">
        ...
        >
          <template #icon>
            <Cog6ToothIcon class="size-7 text-neutral-base" />
          </template>
        </PageHeader>
        <AdminSettingsPageAlt />
      </div>
...
const meta: Meta<typeof AdminSettingsPageAltStory> = {
  title: "Projects/Surbhi's Playground/Pages/Settings (Left Nav)",
  component: AdminSettingsPageAltStory,
  parameters: {
    layout: 'fullscreen',
  },
};
...
type Story = StoryObj<typeof AdminSettingsPageAltStory>;
