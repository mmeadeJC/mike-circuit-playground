...
const TypeCell = markRaw(defineComponent({
  ...
  setup(props) {
    return () => {
      ...
      const icon = isEvent ? BoltIcon : CalendarDaysIcon;
      return h('div', { class: 'flex items-center gap-1.5 p-2 min-h-12' }, [
        h(icon, { class: 'size-4 text-neutral-subtle shrink-0' }),
...
// ── Custom cell: Status (Enabled / Disabled with toggle indicator) ──
    ...
    return () => {
      ...
      return h('div', { class: 'flex items-center gap-1.5 p-2 min-h-12' }, [
        h(isEnabled ? CheckCircleIcon : XCircleIcon, {
          class: isEnabled
            ? 'size-5 text-icon-success-base shrink-0'
            : 'size-5 text-icon-error-base shrink-0',
        }),
      ...
      <div class="flex-[1_1_0] flex flex-col min-w-0 w-full h-full self-stretch">
        ...
        <div class="flex-[1_1_0] flex flex-col min-h-0 h-full w-full">
          ...
          <div v-if="activeTab === 'overview'" class="flex-[1_1_0] flex flex-col min-h-0 h-full w-full bg-neutral-surface">
            ...
            <div class="flex-[1_1_0] flex flex-col min-h-0 h-full px-6">
              <CircuitDataTable
