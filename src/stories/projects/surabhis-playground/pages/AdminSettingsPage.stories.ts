...
const AdminSettingsPageStory = defineComponent({
  name: 'AdminSettingsPageStory',
  components: {
    AppNavigation,
    PageHeader,
    TopBar,
...
const meta: Meta<typeof AdminSettingsPageStory> = {
  title: "Projects/Surbhi's Playground/Pages/Settings",
  component: AdminSettingsPageStory,
  parameters: {
    layout: 'fullscreen',
  },
};
...
type Story = StoryObj<typeof AdminSettingsPageStory>;
