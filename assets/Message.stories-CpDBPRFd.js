import{s}from"./index-CkmisnA9.js";import"./index-0gxlrFf7.js";import"./index-BKtZXsJ2.js";import"./iframe-D7BbHDbG.js";import"./preload-helper-Dp1pzeXC.js";import"./index-oNdbppoo.js";import"./index-1reqc7Wl.js";import"./index-ZhWAdK_X.js";const x={title:"Circuit DS/Components/Message",component:s,tags:["autodocs"],argTypes:{severity:{control:"select",options:["success","info","warn","error","secondary","contrast"]},closable:{control:"boolean"}}},r={render:e=>({components:{Message:s},setup(){return{args:e}},template:'<Message v-bind="args">This is an informational message.</Message>'}),args:{severity:"info"}},a={render:e=>({components:{Message:s},setup(){return{args:e}},template:'<Message v-bind="args">Operation completed successfully.</Message>'}),args:{severity:"success"}},o={render:e=>({components:{Message:s},setup(){return{args:e}},template:'<Message v-bind="args">Please review before proceeding.</Message>'}),args:{severity:"warn"}},t={render:e=>({components:{Message:s},setup(){return{args:e}},template:'<Message v-bind="args">An error occurred.</Message>'}),args:{severity:"error"}};var n,c,g;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`{
  render: args => ({
    components: {
      Message
    },
