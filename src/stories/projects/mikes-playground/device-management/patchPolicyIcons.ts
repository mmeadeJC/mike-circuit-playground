...
/** Platform glyphs shared by the Patch Management list and the policy edit drawer. */

export const WindowsIcon = defineComponent({
  name: 'WindowsIcon',
...
export const LinuxLogoIcon = markRaw(defineComponent({
  name: 'LinuxLogoIcon',
