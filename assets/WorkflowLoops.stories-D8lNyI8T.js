import{d as D,j as $,m as a,r as i}from"./iframe--pVyazG9.js";import{s as M}from"./index-awHdwFoC.js";import{s as R}from"./index-mLzRhsCG.js";import{s as N}from"./index-V_KBkFc6.js";import"./RichText.vue-BtNuFzRg.js";import{_ as j}from"./ToggleSwitch.vue-Cv2ixBss.js";import{_ as F}from"./FormField.vue-DAGeh7uF.js";import{_ as O}from"./AppNavigation.vue-DyTM78Ks.js";import{_ as G}from"./PageHeader.vue-C0DTfLHH.js";import{_ as U}from"./AdminTopBar-YsOJDETq.js";import{w as x,d as q,a as V,b as W,s as H,c as X,p as K,e as J}from"./index-C10Cm2bV.js";import{r as Q}from"./TrashIcon-n8-NWlXQ.js";import{r as Y}from"./ComputerDesktopIcon-DDq7LetA.js";import{r as Z}from"./ArrowsRightLeftIcon-BpXJ-I14.js";import{r as ee}from"./ArrowPathIcon-CKN8GqAu.js";import{r as te}from"./EnvelopeIcon-D8i2uORu.js";import{r as ae}from"./PlusIcon-Ddgts6Le.js";import{r as se}from"./InformationCircleIcon-DHXiAKy4.js";import{r as le}from"./PlayIcon-DsyRbg1A.js";import{r as re}from"./BoltIcon-DQEwEafM.js";import{r as ie}from"./ArrowRightStartOnRectangleIcon-hGdjTmS_.js";import{r as ne}from"./ArrowTopRightOnSquareIcon-dGbNogk4.js";import{r as oe,a as de}from"./RocketLaunchIcon-EZqtAKN2.js";import{r as ce,a as pe}from"./HomeIcon-BIUhWVpo.js";import{r as be}from"./UserIcon-BxZQM_YX.js";import{r as ue}from"./UsersIcon-DQhrqsfm.js";import{r as ve}from"./UserGroupIcon-DtFhSmsY.js";import{r as me}from"./CommandLineIcon-DpVPf4B3.js";import{r as fe}from"./ClipboardDocumentListIcon-wBneEAPl.js";import{r as xe}from"./ShieldCheckIcon-DcBYyFbD.js";import{r as he}from"./Cog6ToothIcon-LI9RgjlE.js";import"./preload-helper-Dp1pzeXC.js";import"./index-6pJfhDGj.js";import"./index-BiPL9L3R.js";import"./index-iMZkGNHR.js";import"./index-Ck1qSbo1.js";import"./index-ZhWAdK_X.js";import"./index-DgH38Tqr.js";import"./index-DlTQV9NJ.js";import"./index-BX6qIScn.js";import"./index-BlXOQGTr.js";import"./index-B-BOOr65.js";import"./index-DaGsjZDs.js";import"./index-CtElKYVw.js";import"./index-BWGkmJ0o.js";import"./index-Cr53P9D2.js";import"./index-DDTNvhH8.js";import"./ExclamationCircleIcon-BLZmoYVZ.js";import"./ExclamationTriangleIcon-C0LU7L06.js";import"./CheckCircleIcon-BsRajZpZ.js";import"./index-CS4MPEf-.js";import"./index-Dd-vKo1S.js";import"./index-CxmVMPmr.js";import"./ChevronRightIcon-Bvh2VZdW.js";import"./index-Bc-xnt0N.js";import"./index-DjfYLa6o.js";import"./index-DCPbTvu2.js";import"./index-8lieu_W4.js";import"./Dropdown.vue-BTsVmqg3.js";import"./EllipsisHorizontalIcon-vlhJGnpU.js";import"./index-CG-HcpwM.js";import"./index-B2GG8oKH.js";import"./AiAgentButton.vue-BqeG1F10.js";import"./ArrowLeftIcon-CWuApAEd.js";import"./FlagIcon-n-8lc86R.js";const ge=[{label:"Get Started",leftIcon:a(oe)},{label:"Home",leftIcon:a(ce)},{label:"Alert",leftIcon:a(pe),count:23,isNew:!0},{label:"User Management",leftIcon:a(ve),items:[{label:"Users",leftIcon:a(be)},{label:"User Groups",leftIcon:a(ue)},{separator:!0},{label:"Active Directory"},{label:"Cloud Directories"},{label:"HR Directories"},{label:"Identity Provider"}]},{label:"Device Management",leftIcon:a(W),items:[{label:"Devices",leftIcon:a(q)},{label:"Device Groups",leftIcon:a(V)},{label:"Commands",leftIcon:a(me)},{label:"Asset Management",leftIcon:a(fe),isNew:!0},{separator:!0},{label:"Policy Management"},{label:"Policy Groups"},{label:"Software Deployment"},{label:"MDM"}]},{label:"Access",leftIcon:a(J),items:[{label:"SSO Applications",leftIcon:a(H)},{label:"Access Reports",isNew:!0},{label:"SaaS Management",leftIcon:a(X)},{label:"Password Management",leftIcon:a(K)},{label:"LDAP"},{label:"RADIUS"}]},{label:"Workflows",leftIcon:a(x),items:[{label:"All Workflows"},{label:"Triggers"}]},{label:"Security",leftIcon:a(xe),items:[{label:"Conditional Access Policies"},{label:"Conditional List"},{label:"MFA Configurations"},{label:"Device Trust"}]},{label:"Insights",leftIcon:a(de),items:[{label:"Reports"},{label:"Directory Insights"}]},{label:"Settings",leftIcon:a(he)}],ye=[{label:"Burak Başcı",itemType:"profile_compact",initials:"BB",name:"Burak Başcı",items:[{label:"Admin IT",itemType:"profile_large",name:"Admin IT",email:"admin_it@company.com",initials:"AT"},{separator:!0},{label:"Logout",rightIcon:a(ie)},{separator:!0},{label:"Change Password"},{label:"Launch User Portal",rightIcon:a(ne)},{separator:!0},{label:"Billing"},{label:"My API Key"},{separator:!0},{label:"Use Old Navigation",itemType:"button"}]}],Ie=[{label:"Overview",value:"overview"},{label:"Execution history",value:"execution-history"}],we=D({name:"WorkflowLoopsPage",components:{AppNavigation:O,PageHeader:G,ToggleSwitch:j,FormField:F,PvButton:M,PvInputText:R,PvSelect:N,AdminTopBar:U,BoltIcon:re,PlayIcon:le,XMarkIcon:$,InformationCircleIcon:se,PlusIcon:ae,EnvelopeIcon:te,ArrowPathIcon:ee,ArrowsRightLeftIcon:Z,ComputerDesktopIcon:Y,TrashIcon:Q},setup(){const h=i("overview"),g=i(!0),y=i(null);let I=3,b=10;const l=i([{id:1,label:"If",type:"if",conditionLogic:"AND",conditions:[{id:1,variable:"user.id",operator:"equals",value:"admin"}],actions:[{id:1,label:"Remove devices",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"}]},{id:2,label:"Else",type:"else",conditionLogic:"AND",conditions:[],actions:[]}]),n=i(1),o=i(null),d=i(""),w=()=>l.value.find(t=>t.id===n.value),k=t=>{const e=l.value.find(s=>s.id===t);e&&e.conditions.push({id:b++,variable:"",operator:"equals",value:""})},B=(t,e)=>{const s=l.value.find(r=>r.id===t);s&&s.conditions.length>1&&s.conditions.splice(e,1)},P=()=>{const t=l.value.findIndex(s=>s.type==="else"),e={id:I++,label:`Else if ${l.value.filter(s=>s.type==="else-if").length+1}`,type:"else-if",conditionLogic:"AND",conditions:[{id:b++,variable:"",operator:"equals",value:""}],actions:[]};t>=0?l.value.splice(t,0,e):l.value.push(e),n.value=e.id},A=t=>{const e=l.value.find(r=>r.id===t);if(!e||e.type==="if"||e.type==="else")return;const s=l.value.findIndex(r=>r.id===t);l.value.splice(s,1),n.value===t&&(n.value=l.value[0].id)},_=t=>{const e=l.value.find(s=>s.id===t);!e||e.type==="if"||e.type==="else"||(o.value=t,d.value=e.label)},S=()=>{if(o.value!==null&&d.value.trim()){const t=l.value.find(e=>e.id===o.value);t&&(t.label=d.value.trim())}o.value=null,d.value=""},L=[{label:"Equals",value:"equals"},{label:"Not equals",value:"not_equals"},{label:"Contains",value:"contains"},{label:"Does not contain",value:"not_contains"},{label:"Greater than",value:"greater_than"},{label:"Less than",value:"less_than"},{label:"Is empty",value:"is_empty"},{label:"Is not empty",value:"is_not_empty"}],z=[{label:"user.id",value:"user.id"},{label:"device.id",value:"device.id"},{label:"initiatedby.email",value:"initiatedby.email"},{label:"input.resource.id",value:"input.resource.id"}],E=i("List user systems"),T=[{label:"User suspended event",items:[{label:"user.id",value:"user.id"},{label:"device id",value:"device id"},{label:"initiatedby.email",value:"initiatedby.email"}]},{label:"Get Systems",items:[{label:"List user systems",value:"List user systems",description:"Retrieves a list of systems linked to a user ID."}]}];let C=10;const u=[{actionId:"remove-devices",label:"Remove devices",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"},{actionId:"get-systems",label:"Get Systems",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"},{actionId:"send-email",label:"Send email",icon:"EnvelopeIcon",iconBg:"bg-chart-branding-base"}];return{menuItems:ge,profileMenuItems:ye,pageTabs:Ie,activeTab:h,isEnabled:g,selectedStep:y,branches:l,activeBranchId:n,editingBranchId:o,editingLabel:d,activeBranch:w,addBranch:P,removeBranch:A,startEditing:_,finishEditing:S,addCondition:k,removeCondition:B,operatorOptions:L,conditionVariables:z,loopInputValue:E,variableOptions:T,actionCatalog:u,addActionToBranch:(t,e)=>{const s=l.value.find(p=>p.id===t),r=u.find(p=>p.actionId===e);s&&r&&s.actions.push({id:C++,label:r.label,icon:r.icon,iconBg:r.iconBg})},removeActionFromBranch:(t,e)=>{const s=l.value.find(r=>r.id===t);s&&s.actions.splice(e,1)},WorkflowIcon:a(x)}},template:`
  ...
  `}),Mt={title:"Projects/Bala Playground/Pages/Workflow Loops",component:we,parameters:{layout:"fullscreen"}},c={};var v,m,f;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:"{}",...(f=(m=c.parameters)==null?void 0:m.docs)==null?void 0:f.source}}};const Rt=["Default"];export{c as Default,Rt as __namedExportsOrder,Mt as default};
