...
const meta: Meta<typeof Dialog> = {
  title: "Projects/Mike's Playground/Policy Management - Circuit Migration/Components/Overlays/Dialog",
  component: Dialog,
  parameters: {
    layout: 'padded',
  },
...
export const AppSelection: Story = {
  ...
  render: () => ({
    ...
    setup() {
      ...
      return { visible, searchQuery, selectedAppId, sampleAppList };
    },
    template: `
      <div>
