import{d as E,j as $,m as e,r as o}from"./iframe-DSI7I_YQ.js";import{s as M}from"./index-DdDMkWFP.js";import{s as N}from"./index-CbI5Nc1U.js";import{s as O}from"./index-B2CuMtSM.js";import{s as j}from"./index-B3LPCdXq.js";import"./RichText.vue-DARNTLdh.js";import{_ as R}from"./ToggleSwitch.vue-B4oihBvH.js";import{_ as F}from"./FormField.vue-DvIDnTXZ.js";import{_ as W}from"./AppNavigation.vue-WvpKRwdI.js";import{_ as G}from"./PageHeader.vue-8CZb4mnW.js";import{_ as q}from"./AdminTopBar-Bkm6k6PL.js";import{w as x,d as U,a as V,b as H,s as X,c as K,p as J,e as Q}from"./index-D6mY1Y8s.js";import{r as Y}from"./TrashIcon-BHjh44dq.js";import{r as Z}from"./ComputerDesktopIcon-DE9MREWp.js";import{r as ee}from"./ArrowPathIcon-7slEBIR7.js";import{r as te}from"./EnvelopeIcon-C_peLEE1.js";import{r as ae}from"./PlusIcon-BEMe8u-I.js";import{r as se}from"./InformationCircleIcon-Cz23V1it.js";import{r as re}from"./PlayIcon-DrmRskeo.js";import{r as le}from"./BoltIcon-C3wyoi2B.js";import{r as oe}from"./ArrowRightStartOnRectangleIcon-CiAc9VBg.js";import{r as ne}from"./ArrowTopRightOnSquareIcon-C_EktnJD.js";import{r as ie,a as de}from"./RocketLaunchIcon-Dsyb3UQf.js";import{r as ce,a as be}from"./HomeIcon-CQmrqHE7.js";import{r as pe}from"./UserIcon-CSW82trP.js";import{r as ue}from"./UsersIcon-OEvGzjDd.js";import{r as me}from"./UserGroupIcon-DeF3nAvb.js";import{r as ve}from"./CommandLineIcon-Bs9Wraq9.js";import{r as fe}from"./ClipboardDocumentListIcon-BaP2rSiE.js";import{r as xe}from"./ShieldCheckIcon-nGYAINf2.js";import{r as ge}from"./Cog6ToothIcon-CsHyeCNP.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DASh1IA2.js";import"./index-Cg08wAe5.js";import"./index-Ck3k_J8K.js";import"./index-CwTDpyKH.js";import"./index-ZhWAdK_X.js";import"./index-Cm1NVGCj.js";import"./index-bfryJj2q.js";import"./index-DKupdcS7.js";import"./index-16iY2v2i.js";import"./index-CD_7J42F.js";import"./index-EU9vbBWi.js";import"./index-BuxjV2Ka.js";import"./index-DsdYTbg9.js";import"./index-CxxjhJ-R.js";import"./index-CZjsJVeR.js";import"./ExclamationCircleIcon-BCZOshDp.js";import"./ExclamationTriangleIcon-C6cd8IvR.js";import"./CheckCircleIcon-kOPkOkM8.js";import"./index-BqmjiiIs.js";import"./index-DJOK6PAC.js";import"./index-Bhi6wGVV.js";import"./ChevronRightIcon-vzjO-UCf.js";import"./index-D6LVU54M.js";import"./index-uwcmB5ii.js";import"./index-B89_K_JM.js";import"./index-KUyW3X8b.js";import"./Dropdown.vue-D3A6JM3M.js";import"./EllipsisHorizontalIcon-BAmumi3c.js";import"./index-Cz6kxq3w.js";import"./AiAgentButton.vue-BBdh0oDh.js";import"./ArrowLeftIcon-hMAymlAx.js";import"./FlagIcon-Bax3lVf6.js";const he=[{label:"Get Started",leftIcon:e(ie)},{label:"Home",leftIcon:e(ce)},{label:"Alert",leftIcon:e(be),count:23,isNew:!0},{label:"User Management",leftIcon:e(me),items:[{label:"Users",leftIcon:e(pe)},{label:"User Groups",leftIcon:e(ue)},{separator:!0},{label:"Active Directory"},{label:"Cloud Directories"},{label:"HR Directories"},{label:"Identity Provider"}]},{label:"Device Management",leftIcon:e(H),items:[{label:"Devices",leftIcon:e(U)},{label:"Device Groups",leftIcon:e(V)},{label:"Commands",leftIcon:e(ve)},{label:"Asset Management",leftIcon:e(fe),isNew:!0},{separator:!0},{label:"Policy Management"},{label:"Policy Groups"},{label:"Software Deployment"},{label:"MDM"}]},{label:"Access",leftIcon:e(Q),items:[{label:"SSO Applications",leftIcon:e(X)},{label:"Access Reports",isNew:!0},{label:"SaaS Management",leftIcon:e(K)},{label:"Password Management",leftIcon:e(J)},{label:"LDAP"},{label:"RADIUS"}]},{label:"Workflows",leftIcon:e(x),items:[{label:"All Workflows"},{label:"Triggers"}]},{label:"Security",leftIcon:e(xe),items:[{label:"Conditional Access Policies"},{label:"Conditional List"},{label:"MFA Configurations"},{label:"Device Trust"}]},{label:"Insights",leftIcon:e(de),items:[{label:"Reports"},{label:"Directory Insights"}]},{label:"Settings",leftIcon:e(ge)}],ye=[{label:"Burak Başcı",itemType:"profile_compact",initials:"BB",name:"Burak Başcı",items:[{label:"Admin IT",itemType:"profile_large",name:"Admin IT",email:"admin_it@company.com",initials:"AT"},{separator:!0},{label:"Logout",rightIcon:e(oe)},{separator:!0},{label:"Change Password"},{label:"Launch User Portal",rightIcon:e(ne)},{separator:!0},{label:"Billing"},{label:"My API Key"},{separator:!0},{label:"Use Old Navigation",itemType:"button"}]}],Ie=[{label:"Overview",value:"overview"},{label:"Execution history",value:"execution-history"}],we=E({name:"WorkflowNodesAsCardsPage",components:{AppNavigation:W,PageHeader:G,ToggleSwitch:R,FormField:F,PvButton:M,PvTag:j,PvInputText:N,PvSelect:O,AdminTopBar:q,BoltIcon:le,PlayIcon:re,XMarkIcon:$,InformationCircleIcon:se,PlusIcon:ae,EnvelopeIcon:te,ArrowPathIcon:ee,ComputerDesktopIcon:Z,TrashIcon:Y},setup(){const g=o("overview"),h=o(!0),y=o(null);let I=4,p=20,w=20;const r=o([{id:1,label:"Mac",conditionLogic:"AND",conditions:[{id:1,variable:"useragent.device",operator:"Equals",value:"Mac"}],actions:[{id:1,label:"Remove Device",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark",params:[{id:1,label:"user_id",isCode:!1},{id:2,label:"input.resource.id",isCode:!0}]}]},{id:2,label:"Windows",conditionLogic:"AND",conditions:[{id:2,variable:"useragent.device",operator:"Equals",value:"Windows"}],actions:[]},{id:3,label:"Other Devices",conditionLogic:"AND",conditions:[],actions:[{id:2,label:"Send email",icon:"EnvelopeIcon",iconBg:"bg-chart-branding-base",params:[{id:3,label:"user@example.com",isCode:!1}]}]}]),d=o(1),n=o(null),i=o(""),k=()=>{const t={id:I++,label:`Branch ${r.value.length+1}`,conditionLogic:"AND",conditions:[{id:p++,variable:"",operator:"Equals",value:""}],actions:[]};r.value.push(t),d.value=t.id},B=t=>{if(r.value.length<=1)return;const a=r.value.findIndex(s=>s.id===t);r.value.splice(a,1),d.value===t&&(d.value=r.value[0].id)},P=t=>{const a=r.value.find(s=>s.id===t);a&&(n.value=t,i.value=a.label)},A=()=>{if(n.value!==null&&i.value.trim()){const t=r.value.find(a=>a.id===n.value);t&&(t.label=i.value.trim())}n.value=null,i.value=""},_=t=>{const a=r.value.find(s=>s.id===t);a&&a.conditions.push({id:p++,variable:"",operator:"Equals",value:""})},S=(t,a)=>{const s=r.value.find(l=>l.id===t);s&&s.conditions.length>1&&s.conditions.splice(a,1)},C=[{label:"Equals",value:"Equals"},{label:"Not equals",value:"Not equals"},{label:"Contains",value:"Contains"},{label:"Does not contain",value:"Does not contain"},{label:"Is empty",value:"Is empty"},{label:"Is not empty",value:"Is not empty"}],z=[{label:"useragent.device",value:"useragent.device"},{label:"user.id",value:"user.id"},{label:"device.id",value:"device.id"},{label:"initiatedby.email",value:"initiatedby.email"},{label:"input.resource.id",value:"input.resource.id"}],u=[{actionId:"remove-device",label:"Remove Device",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"},{actionId:"get-systems",label:"Get Systems",icon:"ComputerDesktopIcon",iconBg:"bg-chart-violet-dark"},{actionId:"send-email",label:"Send email",icon:"EnvelopeIcon",iconBg:"bg-chart-branding-base"},{actionId:"sync-ldap",label:"Sync LDAP",icon:"ArrowPathIcon",iconBg:"bg-chart-aster-dark"}],L=(t,a)=>{const s=r.value.find(b=>b.id===t),l=u.find(b=>b.actionId===a);s&&l&&s.actions.push({id:w++,label:l.label,icon:l.icon,iconBg:l.iconBg,params:[]})},D=(t,a)=>{const s=r.value.find(l=>l.id===t);s&&s.actions.splice(a,1)},T=o("List user systems");return{menuItems:he,profileMenuItems:ye,pageTabs:Ie,activeTab:g,isEnabled:h,selectedStep:y,branches:r,activeBranchId:d,editingBranchId:n,editingLabel:i,addBranch:k,removeBranch:B,startEditing:P,finishEditing:A,addCondition:_,removeCondition:S,addAction:L,removeAction:D,operatorOptions:C,conditionVariables:z,actionCatalog:u,loopInputValue:T,variableOptions:[{label:"User suspended event",items:[{label:"user.id",value:"user.id"},{label:"initiatedby.email",value:"initiatedby.email"}]},{label:"Get Systems",items:[{label:"List user systems",value:"List user systems"}]}],WorkflowIcon:e(x)}},template:`
  ...
  `}),Et={title:"Projects/Bala Playground/Pages/Workflow Nodes As Cards",component:we,parameters:{layout:"fullscreen"}},c={};var m,v,f;c.parameters={...c.parameters,docs:{...(m=c.parameters)==null?void 0:m.docs,source:{originalSource:"{}",...(f=(v=c.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};const $t=["Default"];export{c as Default,$t as __namedExportsOrder,Et as default};
